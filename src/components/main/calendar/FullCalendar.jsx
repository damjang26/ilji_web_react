...
export default function FullCalendarExample() {
    const {events, openSidebarForDate, openSidebarForNew, openSidebarForDetail, updateEvent} = useSchedule();
    const { tags } = useTags();
            ...
            {ReactDOM.createPortal(
                ...
                >
                    {journal.has(diaryPopover.date) ? (
                        <>
                            <DiaryPopoverButton> <FaBookOpen/> 일기 보기 </DiaryPopoverButton>
                            <DiaryPopoverButton> <FaTrash/> 일기 삭제 </DiaryPopoverButton>
                            <DiaryPopoverButton> <FaShareAlt/> 일기 공유 </DiaryPopoverButton>
                        </>
                    ) : (
                        <DiaryPopoverButton
                            onClick={() => {
